...
start_trainer() {
    ...
    NEURALBOT_MODEL="$MODEL_PREFIX" NEURALBOT_TIMESTEPS=1000000000 \
        NEURALBOT_LR="${NEURALBOT_LR:-1.5e-4}" NEURALBOT_ENT="${NEURALBOT_ENT:-0.01}" NEURALBOT_ENT_FINAL="${NEURALBOT_ENT_FINAL:-0.0005}" NEURALBOT_ENT_DECAY_FRAC="${NEURALBOT_ENT_DECAY_FRAC:-1.0}" NEURALBOT_KL="${NEURALBOT_KL:-0}" \
