...
#   instance 1 -> shm /neuralbot_shm,  model wow_neuralbot_model_v15_dense, decay 0.25 (slow arm)
...
case "$INST" in
    2) SHM=/dev/shm/neuralbot_shm2; MODEL="${2:-wow_neuralbot_model_i2}"; DECAY=0.25 ;;
    3) SHM=/dev/shm/neuralbot_shm3; MODEL="${2:-wow_neuralbot_model_i3}"; DECAY=0.05 ;;
    *) SHM=/dev/shm/neuralbot_shm; MODEL="${2:-wow_neuralbot_model_v15_dense}"; DECAY=0.25 ;;
esac
